...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.0.333 // indirect
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/cvm v1.0.333 // indirect
